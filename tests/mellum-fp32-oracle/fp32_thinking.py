...
REPO = "JetBrains/Mellum2-12B-A2.5B-Thinking"
REV = "ba4838faad89e968c36f39e76e95319d756714fe"
...
model = AutoModelForCausalLM.from_pretrained(REPO, revision=REV, dtype=torch.float32, device_map="cpu").eval()
